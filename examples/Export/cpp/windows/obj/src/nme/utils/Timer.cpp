...
{
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",23)
	if (((bool(::Math_obj::isNaN(delay)) || bool((delay < (int)0))))){
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",24)
		hx::Throw (::nme::errors::Error_obj::__new(HX_CSTRING("The delay specified is negative or not a finite number"),null()));
	}
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",28)
	super::__construct(null());
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",30)
	this->delay = delay;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",31)
	this->repeatCount = repeatCount;
	HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",32)
...
Void Timer_obj::reset( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",38)
		if ((this->running)){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",39)
			this->stop();
		}
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",42)
		this->currentCount = (int)0;
	}
return null();
}
...
Void Timer_obj::start( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",47)
		if ((!(this->running))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",50)
			this->running = true;
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",51)
			this->timer = ::haxe::Timer_obj::__new(this->delay);
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",52)
...
Void Timer_obj::stop( ){
{
		...
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",59)
		this->running = false;
		HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",61)
		if (((this->timer != null()))){
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",63)
			this->timer->stop();
			HX_SOURCE_POS("C:\\Motion-Twin\\haxe\\lib\\nme/3,2,0/nme/utils/Timer.hx",64)
			this->timer = null();
		}
	}
return null();
