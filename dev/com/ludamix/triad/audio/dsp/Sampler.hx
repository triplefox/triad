...
class Sampler
{
	...
	// FIXME: I haven't actually ported this yet. It's kind of HTML5-specific.
	
	public function new(file, bufferSize, sampleRate, playStart, playEnd, loopStart, loopEnd, loopMode) 
	{
		this.file = file;
